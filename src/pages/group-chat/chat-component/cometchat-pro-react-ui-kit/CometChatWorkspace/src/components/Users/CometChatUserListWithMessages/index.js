...
import { CometChatUserList, CometChatUserDetails } from "../index";
...
class CometChatUserListWithMessages extends React.Component {
  ...
  render() {
    ...
    if(this.state.threadmessageview) {
      threadMessageView = (
        <div style={userScreenSecondaryStyle(this.props)} className="contacts__secondary-view">
    ...
    return (
      <div style={userScreenStyle(this.props.theme)} className="cometchat cometchat--contacts" dir={Translator.getDirection(this.state.lang)}>
        <div style={userScreenSidebarStyle(this.state, this.props)} className="contacts__sidebar">
          <CometChatUserList
          theme={this.props.theme}
          item={this.state.item}
          type={this.state.type}
        ...
        <div style={userScreenMainStyle(this.state, this.props)} className="contacts__main">{messageScreen}</div>
        {detailScreen}
        {threadMessageView}
        {imageView}
