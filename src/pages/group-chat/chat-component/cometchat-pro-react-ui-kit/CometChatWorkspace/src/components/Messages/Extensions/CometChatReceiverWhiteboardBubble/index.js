            ...
            onMouseLeave={this.handleMouseHover}>
                ...
                <div style={messageWrapperStyle()} className="message__wrapper">
                    ...
                    <div style={messageDetailStyle()} className="message__details">
                        {name}
                        {toolTipView}
                        <div style={messageTxtContainerStyle()} className="message__whiteboard__container">
                            <div style={messageTxtWrapperStyle(this.props)} className="message__whiteboard__wrapper">
                                <div style={messageTxtTitleStyle(this.props)} className="message__whiteboard__title">
                                    <img src={whiteboardIcon} alt={Translator.translate("COLLABORATIVE_WHITEBOARD", this.props.lang)} />
                                    <p style={messageTxtStyle()} className="whiteboard__title">{documentTitle}</p>
                                </div>
                                
                                <ul style={messageBtnStyle(this.props)} className="whiteboard__button">
