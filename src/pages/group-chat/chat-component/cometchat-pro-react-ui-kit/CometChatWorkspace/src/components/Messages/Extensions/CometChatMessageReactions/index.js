    ...
    getMessageReactions = (reaction) => {
        ...
        const messageReactions = Object.keys(reaction).map((data, key) => {
            ...
            return (
                <div
                key={key}
                style={messageReactionsStyle(this.props, reactionData)}
                ...
                onClick={this.triggerEmojiClick}>
                    ...
                    <span style={reactionCountStyle(this.props)} className="reaction__count">{reactionCount}</span>
                </div>
            );
        });
