...
class CometChatMessageThread extends React.PureComponent {
  ...
  render() {
    ...
    let seperator = (<div style={messageSeparatorStyle(this.props)}><hr/></div>);
    if (this.state.parentMessage.hasOwnProperty("replyCount")) {
      ...
      seperator = (
        <div style={messageSeparatorStyle(this.props)} className="message__separator">
          <span style={messageReplyStyle()} className="message__replies">{replyText}</span>
          <hr/>
        </div>
      );
    }
    ...
    return (
      <div style={wrapperStyle(this.props)} className="thread__chat">
        <div style={headerStyle(this.props)} className="chat__header">
          <div style={headerWrapperStyle()} className="header__wrapper">
            <div style={headerDetailStyle()} className="header__details">
              <h6 style={headerTitleStyle()} className="header__title">{Translator.translate("THREAD", this.props.lang)}</h6>
              <span style={headerNameStyle()} className="header__username">{this.props.item.name}</span>
            </div>
            <div style={headerCloseStyle(clearIcon)} className="header__close" onClick={() => this.props.actionGenerated("closeThreadClicked")}></div>
          </div>
        </div>
        <div style={messageContainerStyle()} className="chat__message__container">
          <div style={parentMessageStyle(this.props.parentMessage)} className="parent__message">{parentMessage}</div>
          {seperator}
