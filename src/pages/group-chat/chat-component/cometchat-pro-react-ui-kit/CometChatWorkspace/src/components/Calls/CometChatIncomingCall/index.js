                    ...
                    <div style={callContainerStyle()} className="callalert__container">
                        <div style={headerWrapperStyle()} className="callalert__header">
                            <div style={callDetailStyle()} className="header__detail">
                                <div style={nameStyle()} className="name">{this.state.incomingCall.sender.name}</div>
                        ...
                        <div style={headerButtonStyle()} className="callalert__buttons">
                            <button type="button" style={ButtonStyle(this.props, 0)} className="button button__decline" onClick={this.rejectCall}>{Translator.translate("DECLINE", this.props.lang)}</button>
                            <button type="button" style={ButtonStyle(this.props, 1)} className="button button__accept" onClick={this.acceptCall}>{Translator.translate("ACCEPT", this.props.lang)}</button>
                        </div>
                    </div>
                </div>
            );
