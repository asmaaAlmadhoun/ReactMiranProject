  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <div style={footerStyle()} className="sidebar__footer">
          <div style={navbarStyle()} className="footer__navbar">
            <div style={itemStyle()} className="navbar__item" onClick={() => this.props.actionGenerated('tabChanged', this.props.tabs["CHATS"])}>
              <div 
              style={itemLinkStyle(chatGreyIcon, chatBlueIcon, chatsTabActive, this.props.tabs["CHATS"])}
              className="item__link item__link__chats"
              title={Translator.translate("CHATS", this.props.lang)}></div>
            </div>
            <div style={itemStyle()} className="navbar__item" onClick={() => this.props.actionGenerated('tabChanged', this.props.tabs["USERS"])}>
              <div 
              style={itemLinkStyle(contactGreyIcon, contactBlueIcon, userTabActive, this.props.tabs["USERS"])}
              className="item__link item__link__contacts"
              title={Translator.translate("USERS", this.props.lang)}></div>
            </div>
            <div style={itemStyle()} className="navbar__item" onClick={() => this.props.actionGenerated('tabChanged', this.props.tabs["GROUPS"])}>
              <div 
              style={itemLinkStyle(groupGreyIcon, groupBlueIcon, groupsTabActive, this.props.tabs["GROUPS"])}
              className="item__link item__link__groups"
              title={Translator.translate("GROUPS", this.props.lang)}></div>
            </div>
            <div style={itemStyle()} className="navbar__item" onClick={() => this.props.actionGenerated('tabChanged', this.props.tabs["INFO"])}>
              <div 
              style={itemLinkStyle(moreGreyIcon, moreBlueIcon, moreTabActive, this.props.tabs["INFO"])}
