  ...
  getMessageText = () => {
    ...
    messageText = (
      <div style={messageTxtWrapperStyle(this.props)} className="message__txt__wrapper">
        <p style={messageTxtStyle(this.props, parsedMessage, emojiMessage, showVariation)} className="message__txt">{parsedMessage}{this.state.translatedMessage}</p>
      </div>
    );
  ...
  render() {
    ...
    return (
      ...
      onMouseLeave={this.handleMouseHover}>
        ...
        {toolTipView}
        <div style={messageWrapperStyle()} className="message__wrapper">{messageText}</div>
