      ...
      onMouseLeave={this.handleMouseHover}>
        ...
        <div style={messageWrapperStyle()} className="message__wrapper">
          ...
          <div style={messageDetailStyle()} className="message__details">
            {name}
            {toolTipView}
            <div style={messageFileContainerStyle(this.props)} className="message__file__container">
              <div style={messageFileWrapperStyle(this.props)} className="message__file__wrapper">
