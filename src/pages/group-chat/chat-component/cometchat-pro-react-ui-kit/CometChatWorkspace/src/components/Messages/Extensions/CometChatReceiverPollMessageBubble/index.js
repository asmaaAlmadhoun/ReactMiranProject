        ...
        for (const option in pollExtensionData.options) {
            ...
            const template = (
                <li key={option} onClick={(event) => this.answerPollQuestion(event, option)}>
                    <div style={pollPercentStyle(this.props, width)}> </div>
                    <div style={answerWrapperStyle(this.props, optionData, checkIcon)}>
                        <span>{width}</span>
                        <p>{optionData.text}</p>
                    </div>
                </li>
            ...
            onMouseLeave={this.handleMouseHover}>
                ...
                <div style={messageWrapperStyle()} className="message__wrapper">
                    ...
                    <div style={messageDetailStyle()} className="message__details">
                        {name}
                        {toolTipView}
                        <div style={messageTxtContainerStyle()} className="message__poll__container">
                            <div style={messageTxtWrapperStyle(this.props)} className="message__poll__wrapper">
                                <p style={pollQuestionStyle()} className="poll__question">{pollExtensionData.question}</p>
                                <ul style={pollAnswerStyle(this.props)} className="poll__options">
                                    {pollOptions}
                                </ul>
                                <p style={pollTotalStyle()} className="poll__votes">{totalText}</p>
                            </div>
                        </div>
