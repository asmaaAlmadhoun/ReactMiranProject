...
class CometChatCreatePoll extends React.Component {
    ...
    render() {
        ...
        if (this.state.error) {
            errorContainer = (
                <tr className="error">
                    <td colSpan="3"><div style={modalErrorStyle()}>{this.state.error}</div></td>
                </tr>
            );
        }
        ...
        return (
            <React.Fragment>
                ...
                <div style={modalWrapperStyle(this.props)} className="modal__createpoll">
                    <span style={modalCloseStyle(clearIcon)} className="modal__close" onClick={this.props.close} title={Translator.translate("CLOSE", this.props.lang)}></span>
                    <div style={modalBodyStyle()} className="modal__body">
                        <table style={modalTableStyle(this.props)}>
                            <caption style={tableCaptionStyle()} className="modal__title">{Translator.translate("CREATE_POLL", this.props.lang)}</caption>
                            <tbody style={tableBodyStyle()}>
                                ...
                                <tr>
                                    ...
                                    <td style={iconWrapperStyle()}>
                                        <span tabIndex="100" style={addOptionIconStyle(addIcon)} className="option__add" onClick={this.addPollOption}></span>
                                    </td>
                                </tr>
                            </tbody>
                            <tfoot style={tableFootStyle(this.props, this.state, ringIcon)}>
