...
import { CometChatMessageActions, CometChatThreadedMessageReplyCount, CometChatReadReceipt, CometChatLinkPreview} from "../index";
...
class CometChatReceiverTextMessageBubble extends React.Component {
  ...
  getMessageText = () => {
    ...
    messageText = (
      <div style={messageTxtWrapperStyle(this.props)} className="message__txt__wrapper">
        <p style={messageTxtStyle(parsedMessage, emojiMessage, showVariation)} className="message__txt">{parsedMessage}{this.state.translatedMessage}</p>
      </div>
    );
      ...
      onMouseLeave={this.handleMouseHover}>
        ...
        <div style={messageWrapperStyle()} className="message__wrapper">
          ...
          <div style={messageDetailStyle()} className="message__details">
            {name}
            {toolTipView}
            <div style={messageTxtContainerStyle()} className="message__text__container">{messageText}</div>
