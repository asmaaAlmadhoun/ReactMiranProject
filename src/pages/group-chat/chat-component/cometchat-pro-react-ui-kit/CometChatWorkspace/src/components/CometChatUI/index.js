...
class CometChatUI extends React.Component {
  ...
  render() {
    ...
    if(this.state.threadmessageview) {
      threadMessageView = (
        <div style={unifiedSecondaryStyle(this.props)} className="unified__secondary-view">
    ...
    return (
        ...
        <div style={unifiedMainStyle(this.state, this.props)} className="unified__main">{messageScreen}</div>
        {detailScreen}
        {threadMessageView}
        {imageView}
