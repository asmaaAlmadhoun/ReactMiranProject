...
// import { checkMessageForExtensionsData, validateWidgetSettings } from "@cometchat-pro/chat/util/common";
//
...
//     iconArrowDownStyle,
// } from "./chat-messaging.component";
//
// class ChatMessagingComponent extends React.PureComponent {
//
//     constructor(props) {
//
//         super(props);
...
//             const messageText = (unreadMessageCount > 1) ? `${unreadMessageCount} ${t("NEW_MESSAGES")}` : `${unreadMessageCount} ${t("NEW_MESSAGE")}`;
//             newMessageIndicator = (
//                 <div style={messagePaneTopStyle()} className="message_pane__top">
//                     <div style={messagePaneBannerStyle(this.props)} className="message_pane__banner">
//                         <div style={messagePaneUnreadBannerStyle()} className="message_pane__unread_banner__banner" title={t("JUMP")}>
//                             <button type="button" style={messagePaneUnreadBannerMessageStyle(this.props)} className="message_pane__unread_banner__msg" onClick={this.jumpToMessages}>
//                                 <span style={iconArrowDownStyle()} className="icon--arrow-down">&#x2193; </span>{messageText}
//                             </button>
//                         </div>
//                     </div>
//                 </div>
...
//             liveReactionView = (
//                 <div style={reactionsWrapperStyle()}>
...
//         return (
//             <React.Fragment>
//                 <div style={chatWrapperStyle(this.props.theme)} className="main__chat" dir={Translator.getDirection(this.state.lang)}>
